...
class Wallet(Base):
    ...
    id = Column(Integer, ForeignKey('user_tab.id', ondelete='CASCADE'), primary_key=True)
...
class AccountBook(Base):
    ...
    id = Column(Integer, ForeignKey('group_tab.id', ondelete='CASCADE'), primary_key=True)
...
class Bill(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    user_id=Column(Integer, ForeignKey('user_tab.id', ondelete='CASCADE'))
    account_id=Column(Integer, ForeignKey('account_tab.id', ondelete='CASCADE'))
    book_id=Column(Integer, ForeignKey('account_book_tab.id', ondelete='CASCADE'))
    time=Column(Integer, default=datetime.datetime.now())
